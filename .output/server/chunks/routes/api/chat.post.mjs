...
`);
  ...
  try {
    ...
    for (const cmd of mcpServers || []) {
      ...
      client.setRequestHandler({ method: "roots/list" }, async () => {
        return {
          roots: [
            {
      ...
      client.setRequestHandler({ method: "sampling/createMessage" }, async (req) => {
        var _a, _b, _c;
        ...
        const samplingRes = await fetch(`${baseURL}/chat/completions`, {
          ...
          body: JSON.stringify({
            model: ((_c = (_b = (_a = req.params.modelPreferences) == null ? void 0 : _a.hints) == null ? void 0 : _b[0]) == null ? void 0 : _c.name) || selectedModel,
            messages: req.params.messages,
            max_tokens: req.params.maxTokens || 1e3
          })
        });
