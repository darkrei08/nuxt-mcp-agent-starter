import { shallowReactive, reactive, effectScope, getCurrentScope, hasInjectionContext, getCurrentInstance, inject, toRef, computed, defineComponent, h, isReadonly, isRef, isShallow, isReactive, toRaw, ref, watch, mergeProps, useSSRContext, defineAsyncComponent, unref, provide, onErrorCaptured, onServerPrefetch, createVNode, resolveDynamicComponent, createApp } from "vue";
import { $fetch as $fetch$1 } from "/home/ema/Scrivania/altri repooo/nuxt-mcp-agent-starter/node_modules/ofetch/dist/node.mjs";
import { baseURL } from "#internal/nuxt/paths";
import { createHooks } from "/home/ema/Scrivania/altri repooo/nuxt-mcp-agent-starter/node_modules/hookable/dist/index.mjs";
import { getContext } from "/home/ema/Scrivania/altri repooo/nuxt-mcp-agent-starter/node_modules/unctx/dist/index.mjs";
import { sanitizeStatusCode, createError as createError$1 } from "/home/ema/Scrivania/altri repooo/nuxt-mcp-agent-starter/node_modules/h3/dist/index.mjs";
import { hasProtocol, joinURL, withQuery, parseURL, encodePath, decodePath, isScriptProtocol, isEqual, stringifyParsedURL, stringifyQuery, parseQuery } from "/home/ema/Scrivania/altri repooo/nuxt-mcp-agent-starter/node_modules/ufo/dist/index.mjs";
import { defu } from "/home/ema/Scrivania/altri repooo/nuxt-mcp-agent-starter/node_modules/defu/dist/defu.mjs";
import { ssrRenderAttrs, ssrIncludeBooleanAttr, ssrRenderList, ssrRenderAttr, ssrLooseContain, ssrLooseEqual, ssrInterpolate, ssrRenderClass, ssrRenderComponent, ssrRenderSuspense, ssrRenderVNode } from "vue/server-renderer";
if (!globalThis.$fetch) {
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import("./_nuxt/error-404-D1XY33Dy.js"));
    const _Error = defineAsyncComponent(() => import("./_nuxt/error-500-BizJoRMO.js"));
